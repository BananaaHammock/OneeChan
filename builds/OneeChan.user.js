...
// @updateURL    https://bananaahammock.github.io/OneeChan/builds/OneeChan.meta.js
// @downloadURL  https://bananaahammock.github.io/OneeChan/builds/OneeChan.user.js
...
(function() {
    var defaultConfig = {
        ...
        NAMESPACE = "OneeChan.",
        VERSION = "5.6.2",
        CHANGELOG = "https://github.com/bananaahammock/OneeChan/blob/master/CHANGELOG.md",
    ...
    $SS = {
        ...
        options: {
            ...
            show: function() {
                if ($("#overlay").exists())
                    ...
                    var overlay = $("<div id=overlay>").bind("click", $SS.options.close),
                        ...
                        "<a href='https://github.com/bananaahammock/OneeChan/wiki' id=changelog-link target='_blank' title='Learn about OneeChan.'>Wiki</a><span class=link-delim> | </span>" +
                        "<a href='https://github.com/bananaahammock/OneeChan/blob/master/CHANGELOG.md' id=changelog-link target='_blank' title='Read the changelog.'>Changelog</a><span class=link-delim> | </span>" +
                        "<a href='https://github.com/bananaahammock/OneeChan/blob/master/CONTRIBUTING.md#reporting-bugs-and-suggestions' id=issues-link target='_blank' title='Report an issue.'>Issues</a></p>",
                        key, val, des;
            ...
            createThemesTab: function(tOptions) {
                ...
                p.append($("<a class='options-button' href='https://github.com/bananaahammock/OneeChan/wiki/Custom-Themes' title='Learn more about custom themes and download new ones.' target='_blank'>Custom Themes"));
